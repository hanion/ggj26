...
void InitEpisode5(Level *level) {
    ...
    if (bg1.id == 0) bg1 = LoadTexture("assets/environment/background_1.png");
    if (bg2.id == 0) bg2 = LoadTexture("assets/environment/background_2.png");
    if (bg3.id == 0) bg3 = LoadTexture("assets/environment/background_3.png");
    if (bg4.id == 0) bg4 = LoadTexture("assets/environment/background_4.png");
    if (bg5.id == 0) bg5 = LoadTexture("assets/environment/background_5.png");
